...
class StandardBT45C2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_standard_bt45c_2, container, false)
        ...
        btnNext.setOnClickListener {
            parentFragmentManager.beginTransaction()
                .replace(R.id.fragmentContainerView, StandardBT45C3())
                ?.addToBackStack("fragment_standard_bt45c_2")
                ?.commit()
        }
